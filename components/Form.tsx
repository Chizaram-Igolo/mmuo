  ...
  return (
    ...
    >
      ...
      <div className="buttonWrapper">
        ...
        <div className="css-1skska7 e7kuofc3">
          <a
            href="https://cloud.digitalocean.com/registrations/google"
            className="css-lk03xl flex w-full items-center justify-center self-center bg-white mb-4 border border-[#c0c2d3] rounded-lg shadow-[0_4px_0_rgb(222,225,231)] hover:shadow-[0_2px_0_rgb(222,225,231)] box-border text-[#000824] font-medium py-2 px-6 transition-all duration-200"
          >
            <img
