          ...
          <>
            <Popover.Button
              className={`
                ...
                group inline-flex items-center rounded-full bg-sky-100 
                px-2 py-2 text-base font-medium text-white relative -top-[0.15em]
            ...
            >
              ...
              <ChevronDownIcon
                className={`${open ? "" : "text-opacity-70"}
                  h-5 w-5 text-blue-900 transition duration-150 
