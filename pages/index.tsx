        ...
        <div className="css-85iaxa e1qd68fe0 box-border my-0 mx-auto max-w-[90rem] py-0 w-full">
          <div className="css-3uq0cx columns is-tablet is-gapless is-multiline">
            <div className="column is-4">
              <div className="css-1muv3lt ea5ndez0 flex z-20">
                <div className="css-1l4w6pd ea5ndez1 items-center justify-center z-20">
                  <Image
                ...
                <div className="css-pz3cfz ea5ndez2m flex flex-col ml-2 mb-12 z-20">
