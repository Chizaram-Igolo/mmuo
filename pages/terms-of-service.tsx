    ...
    <section className="py-6 px-5 sm:px-8 md:px-18 lg:px-20 xl:px-24 z-20">
      <div>
        ...
        <p>
          ...
          <span className="font-WorkSans_SemiBold">mmuo.xyz</span> (together or
          individually “Service”) operated by{" "}
          <span className="font-WorkSans_SemiBold">Mmuo LLC</span>.
        </p>
        <p>
        ...
        <p className="font-WorkSans_SemiBold">2. Communications</p>
        <p>
        ...
        <p className="font-WorkSans_SemiBold">3. Purchases</p>
        <p>
        ...
        <p className="font-WorkSans_SemiBold">5. Subscriptions</p>
        <p>
        ...
        <p>
          ...
          you automatically authorize Mmuo LLC to charge all Subscription fees
          incurred through your account to any such payment instruments.
        </p>
        <p>
          Should automatic billing fail to occur for any reason, Mmuo LLC
          reserves the right to terminate your access to the Service with
          immediate effect.
        </p>
        <p className="font-WorkSans_SemiBold">6. Free Trial</p>
        <p>
          Mmuo LLC may, at its sole discretion, offer a Subscription with a free
          trial for a limited period of time (&ldquo;Free Trial&rdquo;).
        </p>
        <p>
        ...
        <p>
          ...
          Trial, you will not be charged by Mmuo LLC until Free Trial has
        ...
        <p>
          At any time and without notice, Mmuo LLC reserves the right to (i)
          modify Terms of Service of Free Trial offer, or (ii) cancel such Free
          Trial offer.
        </p>
        <p className="font-WorkSans_SemiBold">7. Fee Changes</p>
        <p>
          Mmuo LLC, in its sole discretion and at any time, may modify
        ...
        <p>
          Mmuo LLC will provide you with a reasonable prior notice of any change
        ...
        <p className="font-WorkSans_SemiBold">8. Refunds</p>
        <p>
          We issue refunds for Contracts within{" "}
          <span className="font-WorkSans_SemiBold">30 days</span> of the
          original purchase of the Contract.
        </p>
        <p className="font-WorkSans_SemiBold">9. Content</p>
        <p>
          Content found on or through this Service are the property of Mmuo LLC
        ...
        <p className="font-WorkSans_SemiBold">10. Prohibited Uses</p>
        <p>
        ...
        <p className="font-WorkSans_SemiBold">11. Analytics</p>
        <p>
          We may use third-party Service Providers to monitor and analyze the
          use of our Service.
        </p>
        <p className="font-WorkSans_SemiBold">12. No Use By Minors</p>
        <p>
        ...
        <p className="font-WorkSans_SemiBold">13. Accounts</p>
        <p>
        ...
        <p className="font-WorkSans_SemiBold">14. Intellectual Property</p>
        <p>
          Service and its original content (excluding Content provided by
          users), features and functionality are and will remain the exclusive
          property of Mmuo LLC and its licensors. Service is protected by
          ...
          without the prior written consent of Mmuo LLC.
        </p>
        <p className="font-WorkSans_SemiBold">15. Copyright Policy</p>
        <p>
        ...
        <p>
          ...
          to chizaram.igolo@yahoo.com, with the subject line: “Copyright
        ...
        <p>
          You may provide us either directly at chizaram.igolo@yahoo.com or via
        ...
        <p className="font-WorkSans_SemiBold">18. Links To Other Web Sites</p>
        <p>
          Our Service may contain links to third party web sites or services
          that are not owned or controlled by Mmuo LLC.
        </p>
        <p>
          Mmuo LLC has no control over, and assumes no responsibility for the
        ...
        <p className="font-WorkSans_SemiBold">19. Disclaimer Of Warranty</p>
        <p>
        ...
        <p className="font-WorkSans_SemiBold">20. Limitation Of Liability</p>
        <p>
        ...
        <p className="font-WorkSans_SemiBold">21. Termination</p>
        <p>
        ...
        <p className="font-WorkSans_SemiBold">22. Governing Law</p>
        <p>
        ...
        <p className="font-WorkSans_SemiBold">23. Changes To Service</p>
        <p>
        ...
        <p className="font-WorkSans_SemiBold">24. Amendments To Terms</p>
        <p>
        ...
        <p className="font-WorkSans_SemiBold">25. Waiver And Severability</p>
        <p>
        ...
        <p className="font-WorkSans_SemiBold">26. Acknowledgement</p>
        <p>
          BY USING SERVICE OR OTHER SERVICES PROVIDED BY US, YOU ACKNOWLEDGE
          THAT YOU HAVE READ THESE TERMS OF SERVICE AND AGREE TO BE BOUND BY
          THEM.
        </p>
        <p className="font-WorkSans_SemiBold">27. Contact Us</p>
        <p>
        ...
        <p className="mt-20 text-[0.7em]">
          These{" "}
          <a href="https://policymaker.io/terms-and-conditions/">
            Terms of Service
          </a>{" "}
          were created for{" "}
          <span className="font-WorkSans_SemiBold">mmuo.xyz</span> by{" "}
          <a href="https://policymaker.io">PolicyMaker.io</a> on 2022-07-12.
        </p>
      </div>
    </section>
  );
...
TermsOfServices.getLayout = function getLayout(page: React.ReactElement) {
